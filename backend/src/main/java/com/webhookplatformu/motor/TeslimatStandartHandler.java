...
@Component
@GorevTipi(value = "webhook.teslimat.standart", maxDeneme = 8, timeoutSaniye = 15)
public class TeslimatStandartHandler extends TeslimatHandlerTemel {

    public TeslimatStandartHandler(TeslimatRepository teslimatRepository,
        ...
        super(teslimatRepository, teslimatDenemesiRepository, endpointRepository, olayRepository,
                gonderimYardimcisi, devreKesiciYardimcisi, kullanimSayaciServisi, teslimatMetrikleri);
    }
}
